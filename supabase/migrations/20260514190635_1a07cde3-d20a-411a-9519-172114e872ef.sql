...
BEGIN
  ...
  -- Atualiza contatos: marca como cliente se o telefone existir no CRM
  IF _normalized_phone ~ '^55\d{10,11}$' THEN
    ...
    -- Suprime o popup do ciclo atual (hoje) marcando entradas do leads_pipeline.
    -- Se o cliente mandar nova mensagem amanhã, o popup reinicia normalmente.
